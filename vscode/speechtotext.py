...
config_file_name = "D:\\THESIS\\Microsoft-Cognitive-Services\\speech-to-text\\nlp-demo-21-april-2021\\vscode\\config\\config_file_dev.json"
...
print ("####################################################################################")
print ("IMPORTANT!!!")
print ("Please change the config/config_file_dev.json with your Azure Credentials and folder path!!!")
print ("IMPORTANT!!!")
print ("####################################################################################")
...
def speech_recognize_continuous_from_file(file):
    ...
    # saving to csv file 
    # note: need to save into once CSV file!!
...
location = 'D:\\THESIS\\Microsoft-Cognitive-Services\\speech-to-text\\data2'
location = location
